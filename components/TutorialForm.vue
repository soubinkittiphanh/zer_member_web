...
<template>
    <div class="text-center">
        ...
        <v-card class="pa-4">
            ...
            <v-card-text>
                <v-form ref="form">
                    <v-text-field v-model="form.topic" label="* ຫົວຂໍ້" required :rules="nameRules"></v-text-field>
                    <v-text-field v-model="form.youtubeLink" label="* Link" required :rules="nameRules"></v-text-field>
