<template>
    <div class="text-center">
        ...
        <v-card class="pa-4">
            ...
            <v-card-text>
                <v-form ref="form">
                    <v-text-field disabled v-model="form.id" label="* RECID"></v-text-field>
                    <v-text-field v-model="form.order_level" label="* ລຳດັບການສະແດງ"></v-text-field>
                    <v-text-field v-model="form.name" label="* ຊື່" required :rules="nameRules"></v-text-field>
                    <v-text-field v-model="form.g_name" label="ຊື່ພາສາລາວ"></v-text-field>
                    <v-text-field v-model="form.remark" label="ໝາຍເຫດ"></v-text-field>
