...
var VApp = __webpack_require__(225);
...
var VMain = __webpack_require__(226);
...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/pos/index.vue?vue&type=template&id=5c71439c&
...
var posvue_type_template_id_5c71439c_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c(VApp["a" /* default */], [_c(VMain["a" /* default */], [_c(VContainer["a" /* default */], {
  ...
  })], 1)], 1), _vm._v(" "), _vm.productList ? _c(VDataTable["a" /* default */], {
    attrs: {
      "headers": _vm.headers,
      "search": _vm.search,
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function () {
        ...
        }, [_c(components_VToolbar["a" /* VToolbarTitle */], [_vm._v("ສິນຄ້າທັງຫມົດ: " + _vm._s(_vm.productList.length))]), _vm._v(" "), _c(VDivider["a" /* default */], {
          staticClass: "mx-4",
          attrs: {
            "inset": "",
            "vertical": ""
        ...
        return [_c(VBtn["a" /* default */], {
          ...
          on: {
            "click": function ($event) {
              return _vm.addProduct(item);
            }
          }
        }, [_c(VIcon["a" /* default */], [_vm._v("mdi-cash-register")])], 1)];
      }
    }, {
      key: `item.img_path`,
      fn: function ({
        ...
        return [_c(VAvatar["a" /* default */], [_c(VImg["a" /* default */], {
          attrs: {
            "src": `${_vm.host}/${item.img_path}`,
            "alt": "John"
          }
        })], 1)];
      }
    }], null, true)
  }) : _vm._e()], 1)], 1), _vm._v(" "), _c(VCol["a" /* default */], {
    staticClass: "text-center",
    attrs: {
      "cols": "4"
    }
  ...
  }, _vm._l(_vm.productSelectedList, function (item) {
    ...
    }, [_vm._v("\n                                    " + _vm._s(item.pro_name) + " X " + _vm._s(item.qty) + " " + _vm._s(_vm.formatNumber(item.qty * item.pro_price)) + "\n                                ")])], 1)], 1);
  }), 1)], 1)], 1)], 1)], 1)], 1);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/pos/index.vue?vue&type=template&id=5c71439c&
...
/* harmony default export */ var posvue_type_script_lang_js_ = ({
  ...
  computed: {
    host() {
      return Object(common["c" /* hostName */])();
    }
  },
  async mounted() {
  ...
  methods: {
    formatNumber(val) {
      return Object(common["b" /* getFormatNum */])(val);
    },
    addProduct(product) {
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  posvue_type_template_id_5c71439c_render,
  staticRenderFns,
  false,
  null,
  null,
