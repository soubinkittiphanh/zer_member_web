...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin/walletout/index.vue?vue&type=template&id=898f0782&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"text-center"},[_vm._ssrNode("<h1>ຖອນເຄດິດ Wallet Out</h1> "),_c('v-form',{ref:"form",attrs:{"lazy-validation":""},model:{value:(_vm.valid),callback:function ($$v) {_vm.valid=$$v},expression:"valid"}},[_c('v-text-field',{attrs:{"counter":10,"rules":_vm.nameRules,"label":"ລະຫັດອ້າງອີງ","required":""},model:{value:(_vm.name),callback:function ($$v) {_vm.name=$$v},expression:"name"}}),_vm._v(" "),_c('v-select',{attrs:{"items":_vm.items,"rules":[function (v) { return !!v || 'Item is required'; }],"label":"ໄອດີລູກຄ້າ","required":""},model:{value:(_vm.select),callback:function ($$v) {_vm.select=$$v},expression:"select"}}),_vm._v(" "),_c('v-text-field',{attrs:{"counter":10,"rules":_vm.nameRules,"label":"ຈຳວນເງິນ","required":""},model:{value:(_vm.name),callback:function ($$v) {_vm.name=$$v},expression:"name"}}),_vm._v(" "),_c('v-textarea',{attrs:{"outlined":"","name":"input-7-4","counter":"5","label":"ໝາຍເຫດ","value":"The Woodman set to work at once, and so sharp was his axe that the tree was soon chopped nearly through."}}),_vm._v(" "),_c('v-btn',{staticClass:"mr-4",attrs:{"disabled":!_vm.valid,"color":"success"},on:{"click":_vm.validate}},[_vm._v("\n      ກວດສອບຂໍ້ມູນ\n    ")]),_vm._v(" "),_c('v-btn',{staticClass:"mr-4",attrs:{"color":"error"},on:{"click":_vm.reset}},[_vm._v(" ລ້າງຂໍ້ມູນ ")]),_vm._v(" "),_c('v-btn',{attrs:{"color":"warning"},on:{"click":_vm.resetValidation}},[_vm._v(" ບັນທຶກ ")])],1)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/admin/walletout/index.vue?vue&type=template&id=898f0782&
...
//
//
/* harmony default export */ var walletoutvue_type_script_lang_js_ = ({
  middleware: 'auths',
...
// CONCATENATED MODULE: ./pages/admin/walletout/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var admin_walletoutvue_type_script_lang_js_ = (walletoutvue_type_script_lang_js_); 
...
var component = Object(componentNormalizer["a" /* default */])(
  admin_walletoutvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VForm: VForm["a" /* default */],VSelect: VSelect["a" /* default */],VTextField: VTextField["a" /* default */],VTextarea: VTextarea["a" /* default */]})
