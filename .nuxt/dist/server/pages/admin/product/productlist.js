...
var productlistvue_type_template_id_de348fee_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    ...
    staticClass: "text-h5"
  }, [_vm._v("ເພີ່ມສະຕັອກສິນຄ້າ")])]), _vm._v(" "), _c(components_VCard["c" /* VCardText */], [_c(VContainer["a" /* default */], [_c(VSelect["a" /* default */], {
    attrs: {
      "items": _vm.cardType,
      "item-value": cardType => cardType.card_type_code,
      "item-text": cardType => cardType.card_type_code + ' - ' + cardType.card_type_name,
      "rules": [v => !!v || 'ກະລຸນາເລືອກປະເພດສິນຄ້າ'],
      "label": "ປະເພດສິນຄ້າ",
      "required": ""
    },
    model: {
      value: _vm.selectedCardType,
      callback: function ($$v) {
        _vm.selectedCardType = $$v;
      },
      expression: "selectedCardType"
    }
  ...
  }), _vm._v(" "), _c(VRow["a" /* default */], [_c(VSpacer["a" /* default */]), _vm._v(" "), _c(VBtn["a" /* default */], {
    on: {
      "click": _vm.generateDynamicStock
    }
  }, [_vm._v(_vm._s(!_vm.showlist ? 'ສະແດງລາຍການ' : 'ບໍ່ສະແດງ'))])], 1), _vm._v(" "), _vm.showlist ? _c('div', {
    staticClass: "text-center"
  }, [_vm._l(this.carddata, function (idx) {
    return _c('h4', {
      key: idx
    }, [_vm._v("\n              " + _vm._s(_vm.carddata.indexOf(idx) + 1) + " | " + _vm._s(idx) + "\n            ")]);
  }), _vm._v(" "), _c('br')], 2) : _vm._e()], 1)], 1), _vm._v(" "), _c(components_VCard["a" /* VCardActions */], [_c(VSpacer["a" /* default */]), _vm._v(" "), _c(VBtn["a" /* default */], {
    attrs: {
      "color": "blue darken-1",
      "text": ""
    },
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function () {
        ...
        }), _vm._v(" "), _c(VSpacer["a" /* default */]), _vm._v(" "), _c('NuxtLink', {
          attrs: {
            "to": "/admin/product"
          }
        }, [_vm._v("ສ້າງສິນຄ້າໃຫມ່")])], 1)];
      },
      proxy: true
    }, {
      key: `item.function`,
...
// CONCATENATED MODULE: ./pages/admin/product/productlist.vue?vue&type=template&id=de348fee&
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  productlistvue_type_template_id_de348fee_render,
  staticRenderFns,
  false,
  null,
  null,
...
installComponents(component, {LoadingIndicator: __webpack_require__(224).default,DialogClassicMessage: __webpack_require__(229).default})
