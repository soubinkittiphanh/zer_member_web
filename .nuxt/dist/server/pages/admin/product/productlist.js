...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin/product/productlist.vue?vue&type=template&id=159cee2c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"text-center"},[_vm._ssrNode("<h1>PRODUCT LIST</h1> "),_c('v-dialog',{attrs:{"hide-overlay":"","persistent":"","width":"300"},model:{value:(_vm.isloading),callback:function ($$v) {_vm.isloading=$$v},expression:"isloading"}},[_c('loading-indicator')],1),_vm._ssrNode(" "),_c('v-dialog',{attrs:{"max-width":"300px"},model:{value:(_vm.dialogMessage),callback:function ($$v) {_vm.dialogMessage=$$v},expression:"dialogMessage"}},[_c('dialog-classic-message',{attrs:{"message":_vm.message},on:{"closedialog":function($event){_vm.message = null}}})],1),_vm._ssrNode(" "),_c('v-dialog',{attrs:{"max-width":"600px"},model:{value:(_vm.isstock),callback:function ($$v) {_vm.isstock=$$v},expression:"isstock"}},[_c('v-card',[_c('v-card-title',[_c('span',{staticClass:"text-h5"},[_vm._v("ເພີ່ມສະຕັອກສິນຄ້າ")])]),_vm._v(" "),_c('v-card-text',[_c('v-container',[_c('v-select',{attrs:{"items":_vm.cardType,"item-value":function (cardType) { return cardType.card_type_code; },"item-text":function (cardType) { return cardType.card_type_code + ' - ' + cardType.card_type_name; },"rules":[function (v) { return !!v || 'ກະລຸນາເລືອກປະເພດສິນຄ້າ'; }],"label":"ປະເພດສິນຄ້າ","required":""},model:{value:(_vm.selectedCardType),callback:function ($$v) {_vm.selectedCardType=$$v},expression:"selectedCardType"}}),_vm._v(" "),_c('v-file-input',{ref:"filesfield",attrs:{"accept":".txt","placeholder":"Pick an avatar","prepend-icon":"mdi-file","label":"Stock file"},on:{"change":_vm.attachFile}}),_vm._v(" "),_c('v-row',[_c('span',[_vm._v(_vm._s(this.carddata.length)+" ລາຍການ")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{on:{"click":function($event){_vm.showlist = !_vm.showlist}}},[_vm._v(_vm._s(!_vm.showlist ? 'ສະແດງລາຍການ' : 'ບໍ່ສະແດງ'))])],1),_vm._v(" "),(_vm.showlist)?_c('div',{staticClass:"text-center"},[_vm._l((this.carddata),function(idx){return _c('h4',{key:idx},[_vm._v("\n              "+_vm._s(_vm.carddata.indexOf(idx) + 1)+" | "+_vm._s(idx)+"\n            ")])}),_vm._v(" "),_c('br')],2):_vm._e()],1)],1),_vm._v(" "),_c('v-card-actions',[_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"color":"blue darken-1","text":""},on:{"click":function($event){_vm.isstock = false}}},[_vm._v("\n          ປິດ\n        ")]),_vm._v(" "),_c('v-btn',{attrs:{"color":"blue darken-1","text":""},on:{"click":_vm.stockSubmit}},[_vm._v("\n          ບັນທຶກ\n        ")])],1)],1)],1),_vm._ssrNode(" "),_c('v-card',[_c('v-card-title',[_c('v-text-field',{attrs:{"append-icon":"mdi-magnify","label":"ຊອກຫາ","single-line":"","hide-detailsx":""},model:{value:(_vm.search),callback:function ($$v) {_vm.search=$$v},expression:"search"}})],1),_vm._v(" "),(_vm.loaddata)?_c('v-data-table',{attrs:{"headers":_vm.headers,"search":_vm.search,"items":_vm.loaddata,"items-per-page":_vm.pageLine},scopedSlots:_vm._u([{key:"top",fn:function(){return [_c('v-toolbar',{attrs:{"flat":""}},[_c('v-toolbar-title',[_vm._v("ສິນຄ້າທັງຫມົດ: "+_vm._s(_vm.loaddata.length))]),_vm._v(" "),_c('v-divider',{staticClass:"mx-4",attrs:{"inset":"","vertical":""}}),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{staticClass:"mb-2",attrs:{"color":"primary","dark":""},on:{"click":function($event){_vm.dialogForm = true
...
return [_c('v-icon',{staticClass:"mr-2",attrs:{"small":""},on:{"click":function($event){_vm.editItem(item)
            _vm.isedit = true}}},[_vm._v("\n          mdi-pencil\n        ")]),_vm._v(" "),_c('v-btn',{on:{"click":function($event){return _vm.updateStock(item)}}},[_c('i',{staticClass:"fas fa-cart-plus"}),_vm._v("\n          ເພີ່ມສະຕັອກ\n        ")]),_vm._v(" "),_c('v-btn',{on:{"click":function($event){return _vm.editStock(item)}}},[_c('i',{staticClass:"fas fa-dolly"}),_vm._v("\n          ເບິ່ງສະຕັອກ\n        ")])]}}],null,true)}):_vm._e()],1)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/admin/product/productlist.vue?vue&type=template&id=159cee2c&
...
/* harmony default export */ var productlistvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    editItem(idx) {
      ...
      console.log('OBJ ' + Object.keys(idx)); // const obj=JSON.stringify(idx)
    ...
    attachFile(payload) {
      ...
      if (file) {
        ...
        reader.readAsText(file); // URL.revokeObjectURL(file) // free memory
    ...
    stockSubmit() {
      ...
      this.$axios.post('stock_action_i', stockData).then(res => {
...
installComponents_default()(component, {LoadingIndicator: __webpack_require__(182).default,DialogClassicMessage: __webpack_require__(192).default})
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VCardActions: components_VCard["a" /* VCardActions */],VCardText: components_VCard["b" /* VCardText */],VCardTitle: components_VCard["c" /* VCardTitle */],VContainer: VContainer["a" /* default */],VDataTable: VDataTable["a" /* default */],VDialog: VDialog["a" /* default */],VDivider: VDivider["a" /* default */],VFileInput: VFileInput["a" /* default */],VIcon: VIcon["a" /* default */],VRow: VRow["a" /* default */],VSelect: VSelect["a" /* default */],VSpacer: VSpacer["a" /* default */],VTextField: VTextField["a" /* default */],VToolbar: VToolbar["a" /* default */],VToolbarTitle: components_VToolbar["a" /* VToolbarTitle */]})
