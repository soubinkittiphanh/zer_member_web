...
var cardFormvue_type_template_id_74e66d3d_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
// CONCATENATED MODULE: ./components/card/cardForm.vue?vue&type=template&id=74e66d3d&
    ...
    async stockSubmit() {
      if (this.$refs.myform.validate() && !this.isSubmitting) {
        ...
        await this.$axios.post('/api/card/bulkCreate', stockData).then(res => {
          ...
          console.log(error);
          Object(common["a" /* swalError2 */])(this.$swal, "Error", error.response.data);
        });
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  cardFormvue_type_template_id_74e66d3d_render,
  staticRenderFns,
  false,
  injectStyles,
  null,
...
var productlistvue_type_template_id_b4dbec1e_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
  ...
  })], 1), _vm._ssrNode(" "), _c(VCard["a" /* default */], [_c(components_VCard["d" /* VCardTitle */], [_c(VTextField["a" /* default */], {
    attrs: {
...
// CONCATENATED MODULE: ./pages/admin/product/productlist.vue?vue&type=template&id=b4dbec1e&
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  productlistvue_type_template_id_b4dbec1e_render,
  staticRenderFns,
  false,
  null,
  null,
...
/* nuxt-component-imports */
installComponents(component, {LoadingIndicator: __webpack_require__(228).default,DialogClassicMessage: __webpack_require__(234).default,CardForm: __webpack_require__(332).default})
