...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin/bank/index.vue?vue&type=template&id=8befc51c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"text-center"},[_vm._ssrNode("<span class=\"text-h5\">BANK LIST </span> "),_c('v-dialog',{attrs:{"max-width":"600px"},model:{value:(_vm.dialogForm),callback:function ($$v) {_vm.dialogForm=$$v},expression:"dialogForm"}},[_c('v-card',[_c('v-card-title',[_c('span',{staticClass:"text-h5"},[_vm._v("ທະນາຄານ")])]),_vm._v(" "),_c('v-card-text',[_c('v-container',[_c('v-form',{ref:"form",attrs:{"lazy-validation":""},model:{value:(_vm.valid),callback:function ($$v) {_vm.valid=$$v},expression:"valid"}},[_c('v-text-field',{attrs:{"rules":_vm.rule['cat_id'],"label":"Code","required":""},model:{value:(_vm.form_data.bank_code),callback:function ($$v) {_vm.$set(_vm.form_data, "bank_code", $$v)},expression:"form_data.bank_code"}}),_vm._v(" "),_c('v-text-field',{attrs:{"rules":_vm.rule['cat_name'],"label":"ຊື່ທະນາຄານ","required":""},model:{value:(_vm.form_data.bank_name),callback:function ($$v) {_vm.$set(_vm.form_data, "bank_name", $$v)},expression:"form_data.bank_name"}}),_vm._v(" "),_c('v-textarea',{attrs:{"outlined":"","name":"input-7-4","counter":"5","label":"ໝາຍເຫດ"},model:{value:(_vm.form_data.bank_remark),callback:function ($$v) {_vm.$set(_vm.form_data, "bank_remark", $$v)},expression:"form_data.bank_remark"}})],1)],1)],1),_vm._v(" "),_c('v-card-actions',[_c('v-spacer'),_vm._v(" "),_c('v-btn',{staticClass:"mr-4",attrs:{"color":"error"},on:{"click":_vm.reset}},[_vm._v(" ລ້າງຂໍ້ມູນ ")]),_vm._v(" "),_c('v-btn',{attrs:{"color":"blue darken-1","text":""},on:{"click":function($event){_vm.dialogForm = false}}},[_vm._v("\n          ປິດ\n        ")]),_vm._v(" "),_c('v-btn',{attrs:{"color":"blue darken-1","text":""},on:{"click":_vm.submitDatas}},[_vm._v("\n          ບັນທຶກ\n        ")])],1)],1)],1),_vm._ssrNode(" "),_c('v-dialog',{attrs:{"width":"500","persistent":""},model:{value:(_vm.dialog),callback:function ($$v) {_vm.dialog=$$v},expression:"dialog"}},[_c('dialog-classic-message',{attrs:{"message":_vm.message},on:{"closedialog":function($event){_vm.message = null}}})],1),_vm._ssrNode(" "),_c('v-dialog',{attrs:{"hide-overlay":"","persistent":"","width":"300"},model:{value:(_vm.isloading),callback:function ($$v) {_vm.isloading=$$v},expression:"isloading"}},[_c('loading-indicator')],1),_vm._ssrNode(" "),_c('v-card',[_c('v-card-title',[_c('v-text-field',{attrs:{"append-icon":"mdi-magnify","label":"ຊອກຫາ","single-line":"","hide-details":""},model:{value:(_vm.search),callback:function ($$v) {_vm.search=$$v},expression:"search"}})],1),_vm._v(" "),(_vm.loadData)?_c('v-data-table',{staticClass:"elevation-1",attrs:{"headers":_vm.headers,"items":_vm.loadData,"items-per-page":5,"search":_vm.search},scopedSlots:_vm._u([{key:"top",fn:function(){return [_c('v-toolbar',{attrs:{"flat":""}},[_c('v-toolbar-title',[_vm._v("ທະນາຄານ: "+_vm._s(_vm.loadData.length))]),_vm._v(" "),_c('v-divider',{staticClass:"mx-4",attrs:{"inset":"","vertical":""}}),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{staticClass:"mb-2",attrs:{"color":"primary","dark":""},on:{"click":function($event){_vm.dialogForm = true
              _vm.isedit = false
               _vm.reset()}}},[_vm._v("\n            ສ້າງໃຫມ່\n          ")])],1)]},proxy:true},{key:"item.bank_function",fn:function(ref){
               var item = ref.item;
