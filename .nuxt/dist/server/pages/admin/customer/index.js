...
module.exports.__inject__ = function (context) {
  add("7e0ab02a", content, true, context)
};
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/Wallet.vue?vue&type=template&id=fbd4ce3e&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"text-center"},[_c('v-dialog',{attrs:{"max-width":"300px","persistent":""},model:{value:(_vm.dialogMessage),callback:function ($$v) {_vm.dialogMessage=$$v},expression:"dialogMessage"}},[_c('dialog-classic-message',{attrs:{"message":_vm.message},on:{"closedialog":function($event){_vm.message = null}}})],1),_vm._ssrNode(" "),_c('v-dialog',{attrs:{"hide-overlay":"","persistent":"","width":"300"},model:{value:(_vm.isloading),callback:function ($$v) {_vm.isloading=$$v},expression:"isloading"}},[_c('loading-indicator')],1),_vm._ssrNode(" "),_c('v-card',[_c('v-card-title',[_vm._v("\n      ຈັດການ Wallet "+_vm._s(_vm.form_data.user_id || 'null')+" balance:\n      "+_vm._s(_vm.form_data.user_balance))]),_vm._v(" "),_c('v-container',[_c('v-form',{ref:"form",attrs:{"lazy-validation":""},model:{value:(_vm.valid),callback:function ($$v) {_vm.valid=$$v},expression:"valid"}},[_c('v-text-field',{attrs:{"counter":10,"rules":_vm.rule.idRules,"label":"ໄອດີ","required":"","disabled":""},model:{value:(_vm.form_data.user_id),callback:function ($$v) {_vm.$set(_vm.form_data, "user_id", $$v)},expression:"form_data.user_id"}}),_vm._v(" "),_c('v-select',{attrs:{"items":_vm.loaddata,"item-value":function (item) { return item.txn_id; },"item-text":function (item) { return item.txn_id + ' - ' + item.txn_name; },"append-outer-icon":"mdi-map","menu-props":"auto","hide-details":"","label":"ເລືອກທຸລະກຳ","single-line":"","rules":_vm.rule.txnRule},on:{"change":_vm.selectChange},model:{value:(_vm.form_data.txn_type),callback:function ($$v) {_vm.$set(_vm.form_data, "txn_type", $$v)},expression:"form_data.txn_type"}}),_vm._v(" "),_c('v-text-field',{attrs:{"counter":10,"rules":_vm.rule.amountRules,"label":"ຈຳນວນເງິນ: " + _vm.formatNum(_vm.form_data.txn_his_amount),"required":""},model:{value:(_vm.form_data.txn_his_amount),callback:function ($$v) {_vm.$set(_vm.form_data, "txn_his_amount", $$v)},expression:"form_data.txn_his_amount"}})],1),_vm._v("\n      "+_vm._s(_vm.userId)+"\n      "),_vm._t("default")],2),_vm._v(" "),_c('v-card-actions',[_c('v-spacer'),_vm._v(" "),_c('v-btn',{staticClass:"mr-4",attrs:{"color":"error"},on:{"click":_vm.reset}},[_vm._v(" ລ້າງຂໍ້ມູນ ")]),_vm._v(" "),_c('v-btn',{attrs:{"color":"blue darken-1","text":""},on:{"click":function($event){return _vm.$emit('closewallet')}}},[_vm._v("\n        ປິດ\n      ")]),_vm._v(" "),_c('v-btn',{attrs:{"color":"blue darken-1","text":""},on:{"click":_vm.submitDatas}},[_vm._v(" ບັນທຶກ ")])],1)],1)],2)}
var staticRenderFns = []
    ...
    async submitDatas() {
      ...
      if (this.isedit) {
        await this.$axios.put(urlpath + 'e', this.form_data, header).then(res => {
          this.message = res.data; // this.reset()
        }).catch(er => {
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VCardActions: components_VCard["a" /* VCardActions */],VCardTitle: components_VCard["c" /* VCardTitle */],VContainer: VContainer["a" /* default */],VDialog: VDialog["a" /* default */],VForm: VForm["a" /* default */],VSelect: VSelect["a" /* default */],VSpacer: VSpacer["a" /* default */],VTextField: VTextField["a" /* default */]})
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_523df5d4_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(266);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_523df5d4_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_523df5d4_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_523df5d4_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_523df5d4_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin/customer/index.vue?vue&type=template&id=523df5d4&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"text-center"},[_c('v-dialog',{attrs:{"max-width":"300px","persistent":""},model:{value:(_vm.dialog),callback:function ($$v) {_vm.dialog=$$v},expression:"dialog"}},[_c('dialog-classic-message',{attrs:{"message":_vm.message},on:{"closedialog":function($event){_vm.message = null}}})],1),_vm._ssrNode(_vm._ssrEscape("\n  "+_vm._s(_vm.form_data.cus_id)+"\nbalance:  "+_vm._s(_vm.form_data.cus_balance)+"\n  ")),_c('v-dialog',{attrs:{"max-width":"300px"},model:{value:(_vm.wallet),callback:function ($$v) {_vm.wallet=$$v},expression:"wallet"}},[_c('wallet',{attrs:{"user-id":_vm.form_data.cus_id,"cus-balance":_vm.form_data.cus_balance},on:{"closewallet":function($event){_vm.wallet = false}}})],1),_vm._ssrNode(" "),_c('v-dialog',{attrs:{"hide-overlay":"","persistent":"","width":"300"},model:{value:(_vm.isloading),callback:function ($$v) {_vm.isloading=$$v},expression:"isloading"}},[_c('loading-indicator')],1),_vm._ssrNode(" "),_c('v-dialog',{attrs:{"max-width":"600px"},model:{value:(_vm.dialogForm),callback:function ($$v) {_vm.dialogForm=$$v},expression:"dialogForm"}},[_c('v-card',[_c('v-card-title'),_vm._v(" "),_c('v-card-text',[_c('v-container',[_c('v-form',{ref:"form",attrs:{"lazy-validation":""},model:{value:(_vm.valid),callback:function ($$v) {_vm.valid=$$v},expression:"valid"}},[_c('v-text-field',{attrs:{"counter":10,"rules":_vm.rule.idRules,"label":"ໄອດີລູກຄ້າ","required":"","disabled":""},model:{value:(_vm.form_data.cus_id),callback:function ($$v) {_vm.$set(_vm.form_data, "cus_id", $$v)},expression:"form_data.cus_id"}}),_vm._v(" "),_c('v-text-field',{attrs:{"counter":10,"rules":_vm.rule.nameRules,"label":"ຊື່ລູກຄ້າ","required":""},model:{value:(_vm.form_data.cus_name),callback:function ($$v) {_vm.$set(_vm.form_data, "cus_name", $$v)},expression:"form_data.cus_name"}}),_vm._v(" "),_c('v-text-field',{attrs:{"counter":10,"rules":_vm.rule.passRules,"label":"ລະຫັດຜ່ານ","required":"","type":!_vm.isedit ? '' : 'password'},model:{value:(_vm.form_data.cus_pass),callback:function ($$v) {_vm.$set(_vm.form_data, "cus_pass", $$v)},expression:"form_data.cus_pass"}}),_vm._v(" "),_c('v-text-field',{attrs:{"counter":10,"rules":_vm.rule.nameRules,"label":"ເບີໂທ","required":""},model:{value:(_vm.form_data.cus_tel),callback:function ($$v) {_vm.$set(_vm.form_data, "cus_tel", _vm._n($$v))},expression:"form_data.cus_tel"}}),_vm._v(" "),_c('v-text-field',{attrs:{"counter":10,"rules":_vm.rule.nameRules,"label":"ອີເມວ","required":""},model:{value:(_vm.form_data.cus_email),callback:function ($$v) {_vm.$set(_vm.form_data, "cus_email", _vm._n($$v))},expression:"form_data.cus_email"}}),_vm._v(" "),_c('v-checkbox',{attrs:{"label":"ເປິດໃຊ້ງານທັນທີ"},model:{value:(_vm.form_data.cus_active),callback:function ($$v) {_vm.$set(_vm.form_data, "cus_active", $$v)},expression:"form_data.cus_active"}})],1)],1)],1),_vm._v(" "),_c('v-card-actions',[_c('v-spacer'),_vm._v(" "),_c('v-btn',{staticClass:"mr-4",attrs:{"color":"error"},on:{"click":_vm.reset}},[_vm._v(" ລ້າງຂໍ້ມູນ ")]),_vm._v(" "),_c('v-btn',{attrs:{"color":"blue darken-1","text":""},on:{"click":function($event){_vm.dialogForm = false}}},[_vm._v("\n          ປິດ\n        ")]),_vm._v(" "),_c('v-btn',{attrs:{"color":"blue darken-1","text":""},on:{"click":_vm.submitDatas}},[_vm._v("\n          ບັນທຶກ\n        ")])],1)],1)],1),_vm._ssrNode(" "),_c('v-card',[_c('v-card-title',[_c('v-text-field',{attrs:{"append-icon":"mdi-magnify","label":"ຊອກຫາ","single-line":"","hide-detailsx":""},model:{value:(_vm.search),callback:function ($$v) {_vm.search=$$v},expression:"search"}})],1),_vm._v(" "),(_vm.loaddata)?_c('v-data-table',{attrs:{"headers":_vm.headers,"search":_vm.search,"items":_vm.loaddata},scopedSlots:_vm._u([{key:"top",fn:function(){return [_c('v-toolbar',{attrs:{"flat":""}},[_c('v-toolbar-title',[_vm._v("ລູກຄ້າ: "+_vm._s(_vm.loaddata.length))]),_vm._v(" "),_c('v-divider',{staticClass:"mx-4",attrs:{"inset":"","vertical":""}}),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{staticClass:"mb-2",attrs:{"color":"primary","dark":""},on:{"click":function($event){_vm.dialogForm = true
              _vm.isedit = false}}},[_vm._v("\n            ສ້າງໃຫມ່\n          ")])],1)]},proxy:true},{key:"item.cus_active",fn:function(ref){
              var item = ref.item;
return [_c('v-checkbox',{attrs:{"disabled":""},model:{value:(item.cus_active),callback:function ($$v) {_vm.$set(item, "cus_active", $$v)},expression:"item.cus_active"}})]}},{key:"item.function",fn:function(ref){
              var item = ref.item;
return [_c('v-icon',{staticClass:"mr-2",attrs:{"small":""},on:{"click":function($event){_vm.editItem(item)
            _vm.isedit = true}}},[_vm._v("\n          mdi-pencil\n        ")])]}},{key:"item.wallet",fn:function(ref){
            var item = ref.item;
return [_c('v-btn',{attrs:{"color":"blue darken-1","text":""},on:{"click":function($event){_vm.walletAction(item)
            _vm.wallet = true}}},[_c('i',{staticClass:"fas fa-wallet"})])]}}],null,true)}):_vm._e()],1)],2)}
var staticRenderFns = []
...
var VCheckbox = __webpack_require__(284);

// EXTERNAL MODULE: ./node_modules/vuetify/src/styles/components/_selection-controls.sass
var _selection_controls = __webpack_require__(286);
...
var components_VToolbar = __webpack_require__(206);
...
/* nuxt-component-imports */
installComponents_default()(component, {DialogClassicMessage: __webpack_require__(192).default,Wallet: __webpack_require__(278).default,LoadingIndicator: __webpack_require__(182).default})
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VCardActions: components_VCard["a" /* VCardActions */],VCardText: components_VCard["b" /* VCardText */],VCardTitle: components_VCard["c" /* VCardTitle */],VCheckbox: VCheckbox_VCheckbox,VContainer: VContainer["a" /* default */],VDataTable: VDataTable["a" /* default */],VDialog: VDialog["a" /* default */],VDivider: VDivider["a" /* default */],VForm: VForm["a" /* default */],VIcon: VIcon_VIcon["a" /* default */],VSpacer: VSpacer["a" /* default */],VTextField: VTextField["a" /* default */],VToolbar: VToolbar["a" /* default */],VToolbarTitle: components_VToolbar["a" /* VToolbarTitle */]})
