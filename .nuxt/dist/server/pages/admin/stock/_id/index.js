...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin/stock/_id/index.vue?vue&type=template&id=15b8ed7c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"text-center"},[_vm._ssrNode("<h1>STOCK MANAGEMENT</h1> "),_c('v-dialog',{attrs:{"max-width":"300px"},model:{value:(_vm.dialogMessage),callback:function ($$v) {_vm.dialogMessage=$$v},expression:"dialogMessage"}},[_c('dialog-classic-message',{attrs:{"message":_vm.message},on:{"closedialog":function($event){_vm.message = null}}})],1),_vm._ssrNode(" "),_c('v-dialog',{attrs:{"max-width":"300px","persistent":""},model:{value:(_vm.dialog),callback:function ($$v) {_vm.dialog=$$v},expression:"dialog"}},[_c('dialog-classic-message',{attrs:{"message":_vm.message},on:{"closedialog":function($event){_vm.message = null}}})],1),_vm._ssrNode(" "),_c('v-dialog',{attrs:{"hide-overlay":"","persistent":"","width":"300"},model:{value:(_vm.isloading),callback:function ($$v) {_vm.isloading=$$v},expression:"isloading"}},[_c('loading-indicator')],1),_vm._ssrNode(" "),_c('v-card',[_c('v-card-title',[_c('v-row',[_c('v-col',{attrs:{"cols":"12","lg":"5"}},[_c('v-menu',{ref:"menu1",attrs:{"close-on-content-click":false,"transition":"scale-transition","offset-y":"","max-width":"290px","min-width":"auto"},scopedSlots:_vm._u([{key:"activator",fn:function(ref){
var on = ref.on;
var attrs = ref.attrs;
...
var on = ref.on;
var attrs = ref.attrs;
return [_c('v-text-field',_vm._g(_vm._b({attrs:{"label":"ຫາວັນທີ:","hint":"MM/DD/YYYY format","persistent-hint":"","prepend-icon":"mdi-calendar"},on:{"blur":function($event){_vm.date2 = _vm.parseDate(_vm.dateFormatted2)}},model:{value:(_vm.dateFormatted2),callback:function ($$v) {_vm.dateFormatted2=$$v},expression:"dateFormatted2"}},'v-text-field',attrs,false),on))]}}]),model:{value:(_vm.menu2),callback:function ($$v) {_vm.menu2=$$v},expression:"menu2"}},[_vm._v(" "),_c('v-date-picker',{attrs:{"no-title":""},on:{"input":function($event){_vm.menu2 = false}},model:{value:(_vm.date2),callback:function ($$v) {_vm.date2=$$v},expression:"date2"}})],1)],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","lg":"5"}},[_c('v-text-field',{attrs:{"append-icon":"mdi-magnify","label":"ຊອກຫາ","single-line":"","hide-detailsx":""},model:{value:(_vm.search),callback:function ($$v) {_vm.search=$$v},expression:"search"}}),_vm._v(" "),_c('v-text-field',{attrs:{"append-icon":"mdi-magnify","label":"ລະຫັດແອັດມິນ","single-line":"","hide-detailsx":""},model:{value:(_vm.userId),callback:function ($$v) {_vm.userId=$$v},expression:"userId"}}),_vm._v(" "),_c('v-btn',{on:{"click":_vm.fetchData}},[_vm._v(" ດຶງລາຍງານ ")])],1)],1)],1),_vm._v(" "),(_vm.loaddata)?_c('v-data-table',{attrs:{"headers":_vm.headers,"search":_vm.search,"items":_vm.loaddata},scopedSlots:_vm._u([{key:"top",fn:function(){return [_c('v-toolbar',{attrs:{"flat":""}},[_c('v-toolbar-title',[_vm._v("ສິນຄ້າທັງຫມົດ: "+_vm._s(_vm.loaddata.length))]),_vm._v(" "),_c('v-divider',{staticClass:"mx-4",attrs:{"inset":"","vertical":""}}),_vm._v(" "),_c('v-spacer')],1)]},proxy:true},{key:"item.function",fn:function(ref){
var item = ref.item;
return [(item.status==='ພ້ອມໃຊ້')?_c('v-btn',{on:{"click":function($event){return _vm.delCard(item)}}},[_c('i',{staticClass:"fas fa-trash"})]):_vm._e()]}}],null,true)}):_vm._e()],1)],2)}
var staticRenderFns = []
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VCardTitle: components_VCard["c" /* VCardTitle */],VCol: VCol["a" /* default */],VDataTable: VDataTable["a" /* default */],VDatePicker: VDatePicker["a" /* default */],VDialog: VDialog["a" /* default */],VDivider: VDivider["a" /* default */],VMenu: VMenu["a" /* default */],VRow: VRow["a" /* default */],VSpacer: VSpacer["a" /* default */],VTextField: VTextField["a" /* default */],VToolbar: VToolbar["a" /* default */],VToolbarTitle: components_VToolbar["a" /* VToolbarTitle */]})
