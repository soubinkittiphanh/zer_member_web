...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin/category/index.vue?vue&type=template&id=f10cb5be&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"text-center"},[_vm._ssrNode("<span class=\"text-h5\">Product category </span> "),_c('v-dialog',{attrs:{"max-width":"600px"},model:{value:(_vm.dialogForm),callback:function ($$v) {_vm.dialogForm=$$v},expression:"dialogForm"}},[_c('v-card',[_c('v-card-title',[_c('span',{staticClass:"text-h5"},[_vm._v("Product category "+_vm._s(this.$store.getters.loggedInUser))])]),_vm._v(" "),_c('v-card-text',[_c('v-container',[_c('v-form',{ref:"form",attrs:{"lazy-validation":""},model:{value:(_vm.valid),callback:function ($$v) {_vm.valid=$$v},expression:"valid"}},[_c('v-text-field',{attrs:{"disabled":"","rules":_vm.rule['cat_id'],"label":"ໄອດີໝວດສິນຄ້າ","required":""},model:{value:(_vm.form_data.categ_id),callback:function ($$v) {_vm.$set(_vm.form_data, "categ_id", $$v)},expression:"form_data.categ_id"}}),_vm._v(" "),_c('v-text-field',{attrs:{"rules":_vm.rule['cat_name'],"label":"ຊື່ປະເພດສິນຄ້າ","required":""},model:{value:(_vm.form_data.categ_name),callback:function ($$v) {_vm.$set(_vm.form_data, "categ_name", $$v)},expression:"form_data.categ_name"}}),_vm._v(" "),_c('v-textarea',{attrs:{"outlined":"","name":"input-7-4","counter":"5","label":"ໝາຍເຫດ"},model:{value:(_vm.form_data.categ_desc),callback:function ($$v) {_vm.$set(_vm.form_data, "categ_desc", $$v)},expression:"form_data.categ_desc"}})],1)],1)],1),_vm._v(" "),_c('v-card-actions',[_c('v-spacer'),_vm._v(" "),_c('v-btn',{staticClass:"mr-4",attrs:{"color":"error"},on:{"click":_vm.reset}},[_vm._v(" ລ້າງຂໍ້ມູນ ")]),_vm._v(" "),_c('v-btn',{attrs:{"color":"blue darken-1","text":""},on:{"click":function($event){_vm.dialogForm = false}}},[_vm._v("\n          ປິດ\n        ")]),_vm._v(" "),_c('v-btn',{attrs:{"color":"blue darken-1","text":""},on:{"click":_vm.submitDatas}},[_vm._v("\n          ບັນທຶກ\n        ")])],1)],1)],1),_vm._ssrNode(" "),_c('v-dialog',{attrs:{"width":"500","persistent":""},model:{value:(_vm.dialog),callback:function ($$v) {_vm.dialog=$$v},expression:"dialog"}},[_c('dialog-classic-message',{attrs:{"message":_vm.message},on:{"closedialog":function($event){_vm.message = null}}})],1),_vm._ssrNode(" "),_c('v-dialog',{attrs:{"hide-overlay":"","persistent":"","width":"300"},model:{value:(_vm.isloading),callback:function ($$v) {_vm.isloading=$$v},expression:"isloading"}},[_c('loading-indicator')],1),_vm._ssrNode(" "),_c('v-card',[_c('v-card-title',[_c('v-text-field',{attrs:{"append-icon":"mdi-magnify","label":"ຊອກຫາ","single-line":"","hide-details":""},model:{value:(_vm.search),callback:function ($$v) {_vm.search=$$v},expression:"search"}})],1),_vm._v(" "),(_vm.loadData)?_c('v-data-table',{staticClass:"elevation-1",attrs:{"headers":_vm.headers,"items":_vm.loadData,"items-per-page":5,"search":_vm.search},scopedSlots:_vm._u([{key:"top",fn:function(){return [_c('v-toolbar',{attrs:{"flat":""}},[_c('v-toolbar-title',[_vm._v("ປະເພດສິນຄ້າ: "+_vm._s(_vm.loadData.length))]),_vm._v(" "),_c('v-divider',{staticClass:"mx-4",attrs:{"inset":"","vertical":""}}),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{staticClass:"mb-2",attrs:{"color":"primary","dark":""},on:{"click":function($event){_vm.dialogForm = true
              _vm.isedit = false}}},[_vm._v("\n            ສ້າງໃຫມ່\n          ")])],1)]},proxy:true},{key:"item.categ_function",fn:function(ref){
              var item = ref.item;
return [_c('v-icon',{staticClass:"mr-2",attrs:{"small":""},on:{"click":function($event){_vm.editItem(item)
            _vm.isedit = true}}},[_vm._v("\n          mdi-pencil\n        ")])]}},{key:"item.categ_wallet",fn:function(ref){
            var item = ref.item;
return [_c('v-icon',{staticClass:"mr-2",attrs:{"small":""},on:{"click":function($event){_vm.wallet(item)
            _vm.isedit = true}}},[_vm._v("\n          mdi-pencil\n        ")])]}}],null,true)}):_vm._e()],1)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/admin/category/index.vue?vue&type=template&id=f10cb5be&
...
/* harmony default export */ var categoryvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    async submitDatas() {
      ...
      if (this.isedit) {
        await this.$axios.put(urlpath + 'e', submitData).then(res => {
        ...
        await this.$axios.post(urlpath + 'i', submitData).then(res => {
          this.message = res.data; // this.reset()
        }).catch(er => {
          this.message = 'Error: ' + er;
        });
