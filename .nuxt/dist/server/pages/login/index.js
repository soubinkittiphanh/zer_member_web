...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/Notification.vue?vue&type=template&id=35851136&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"notification is-danger"},[_c('v-alert',{attrs:{"border":"bottom","color":"pink darken-1","dark":""}},[_vm._v("\n  "+_vm._s(_vm.message)+"\n  ")])],1)}
var staticRenderFns = []
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/login/index.vue?vue&type=template&id=1e1601d8&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-app',[_c('v-main',[_c('v-container',{staticClass:"fill-height",attrs:{"fluid":""}},[_c('v-dialog',{attrs:{"hide-overlay":"","persistent":"","width":"300"},model:{value:(_vm.isLoading),callback:function ($$v) {_vm.isLoading=$$v},expression:"isLoading"}},[_c('loading-indicator')],1),_vm._v(" "),_c('v-row',{attrs:{"align":"center","justify":"center","dense":""}},[_c('v-col',{attrs:{"cols":"12","sm":"8","md":"4","lg":"4"}},[_c('v-card',{staticClass:"elevation-1"},[(_vm.errorMessage)?_c('notification',{attrs:{"message":_vm.errorMessage}}):_vm._e(),_vm._v(" "),_c('p',[_vm._v(_vm._s(this.$store.getters.loggedInUser.name))]),_vm._v(" "),_c('v-card-text',[_c('v-form',[_c('v-text-field',{staticClass:"rounded-10",attrs:{"label":"ກະລຸນາ ໃສ່ໄອດີ","name":"email","prepend-inner-icon":"mdi-account-tie-hat","outlined":""},model:{value:(_vm.email),callback:function ($$v) {_vm.email=$$v},expression:"email"}}),_vm._v(" "),_c('v-text-field',{staticClass:"rounded-10",attrs:{"label":"ລະຫັດຜ່ານ","type":"password","name":"password","prepend-inner-icon":"mdi-lock","outlined":""},model:{value:(_vm.password),callback:function ($$v) {_vm.password=$$v},expression:"password"}}),_vm._v(" "),_c('v-btn',{staticClass:"rounded-0",attrs:{"color":"primary","x-large":"","block":"","dark":"","type":"submit"},on:{"click":function($event){$event.preventDefault();return _vm.login.apply(null, arguments)}}},[_vm._v("\n                  login\n                  "),_c('v-icon',[_vm._v(" mdi mdi-login")])],1)],1)],1)],1)],1)],1)],1)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/login/index.vue?vue&type=template&id=1e1601d8&

// EXTERNAL MODULE: ./components/Notification.vue + 4 modules
var Notification = __webpack_require__(264);
...
/* harmony default export */ var loginvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    async login() {
      ...
      await this.$axios.post('mem_auth', payload).then(res => {
...
installComponents_default()(component, {LoadingIndicator: __webpack_require__(182).default,Notification: __webpack_require__(264).default})
...
installComponents_default()(component, {VApp: VApp["a" /* default */],VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VCardText: components_VCard["b" /* VCardText */],VCol: VCol["a" /* default */],VContainer: VContainer["a" /* default */],VDialog: VDialog["a" /* default */],VForm: VForm["a" /* default */],VIcon: VIcon["a" /* default */],VMain: VMain["a" /* default */],VRow: VRow["a" /* default */],VTextField: VTextField["a" /* default */]})
