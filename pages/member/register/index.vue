    ...
    <v-row align="center">
      <v-col cols="12">
        ...
        <v-card-text>
          ...
          <v-text-field v-model="member.name" required outlined></v-text-field>
          <h2 style="color: #b48811">ເບີໂທ*</h2>
          <v-text-field v-model="member.tel" required outlined></v-text-field>
  ...
  methods: {
    ...
    async createEntry() {
      ...
      try {
        ...
        swalSuccess(this.$swal, 'Succeed', 'ການລົງທະບຽນສຳເລັດ ກະລຸນາລັອກອິນ ດ້ວຍເບີໂທ ແລະ ລະຫັດ ທີ່ໄດ້ລົງທະບຽນ')
      } catch (error) {
