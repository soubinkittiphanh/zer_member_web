        ...
        <v-card-title>
          <v-layout row wrap>
            ...
            <v-col cols="6">
              ...
              <v-autocomplete @input="currencyChange(order)" item-text="code" item-value="id" :items="currencyList"
                label="ພະນັກງານຂາຍ*" v-model="order.shippingFeeCurrencyId"></v-autocomplete>
              <v-autocomplete @input="currencyChange(order)" item-text="code" item-value="id" :items="currencyList"
                label="ລູກຄ້າ*" v-model="order.shippingFeeCurrencyId"></v-autocomplete>
              <v-autocomplete @input="currencyChange(order)" item-text="code" item-value="id" :items="currencyList"
                label="ສິນຄ້າ*" v-model="order.shippingFeeCurrencyId"></v-autocomplete>
            </v-col>
